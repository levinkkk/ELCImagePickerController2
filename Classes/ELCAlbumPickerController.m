...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	ELCAssetTablePickerViewController *picker = [[ELCAssetTablePickerViewController alloc] initWithNibName:@"ELCAssetTablePickerViewController" bundle:[NSBundle mainBundle]];
	picker.parent = self;
